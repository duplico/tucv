...
% (c) 2009 George R. Louthan IV <georgerlouth@nthefourth.com> http://georgerloutha.nthefourth.com
%
...
%		\item[CNSS-4012] National Information Assurance Training Standard for Senior Systems Managers
		%\item[CNSS-4013] National Information Assurance Training Standard For System Administrators (Expected 2010)
		%\item[CNSS-4014] Information Assurance Training Standard for Information Systems Security Officers (Expected 2011)
%		\item[CNSS-4015] National Training Standard for Systems Certifiers
		%\item[CNSS-4016] National Information Assurance Training Standard For Risk Analysts (Expected 2010)
%	\end{tabular*}
%\end{description}
%\end{minipage}
%\end{center}
