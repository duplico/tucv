...
\item[] \resdesc{Soft skills}{Flexible and even-tempered; Very strong written 
...
authentication product and advertising platform.}
    ...
    Developed and narrated a series of educational videos for
    Vidoop's products and OpenID. Primary author on the corporate blog.
    Worked closely with developers and business personnel. Staffed exhibit at 
	IT Security World.}
\end{itemize}
...
{Tulsa, OK}
{Web-based version of LPCH's legacy pen-and-paper intake system.
Manages the creation of new patients and basic data collection. Generates patient reports for medical charts.}
...
network protocols using signatures.}
    ...
    Led a network monitoring research group; designed and implemented a
    protocol identification library (SAND).
    Oversaw successful test deployment at FAA Computer Security
    Incident Response Center. Co-developed a multi-touch
    network traffic visualization tool (DVNE). Actively maintaining the library.
    }
